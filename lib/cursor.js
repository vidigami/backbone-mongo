...
(function() {
  ...
  _adaptIds = function(query, backbone_adapter) {
    ...
    if (_.isString(query)) {
      ...
      for (key in query) {
        value = query[key];
        result[key] = _adaptIds(value, backbone_adapter);
      }
      return result;
      ...
      return (function() {
        ...
        for (_i = 0, _len = query.length; _i < _len; _i++) {
          value = query[_i];
          _results.push(_adaptIds(value, backbone_adapter));
        }
        return _results;
      })();
    }
    ...
    MongoCursor.prototype.queryToJSON = function(callback) {
      ...
      return this.buildFindQuery((function(_this) {
        return function(err, find_query) {
          var $fields, args, id, key, _i, _len;
          if (err) {
            return callback(err);
          }
          args = [find_query];
          if (id = args[0].id) {
            delete args[0].id;
            args[0][_this.backbone_adapter.id_attribute] = _adaptIds(id, _this.backbone_adapter);
          }
