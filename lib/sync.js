...
(function() {
  var Backbone, BackboneORM, Connection, DESTROY_BATCH_LIMIT, DatabaseTools, ModelCache, MongoCursor, MongoSync, Queue, Schema, Utils, crypto, generateModelID, moment, util, _, _base,
  ...
  Queue = BackboneORM.Queue, Schema = BackboneORM.Schema, Utils = BackboneORM.Utils;
  ...
  (_base = BackboneORM.CacheSingletons).ModelTypeID || (_base.ModelTypeID = MongoCursor = require('./cursor'));
  ...
  MongoSync = (function() {
    ...
    MongoSync.prototype.destroy = function(query, callback) {
      ...
      QueryCache.reset(this.model_type, (function(_this) {
        return function(err) {};
      })(this));
      return this.connection.collection((function(_this) {
        return function(err, collection) {
