...
(function() {
  var Backbone, BackboneORM, CAPABILITIES, Connection, DESTROY_BATCH_LIMIT, DatabaseTools, MongoCursor, MongoSync, ObjectID, Queue, Schema, Utils, util, _,
  ...
  MongoSync = (function() {
    ...
    MongoSync.prototype.capabilities = function() {
      return CAPABILITIES;
    };
