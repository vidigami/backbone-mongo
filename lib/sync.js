...
(function() {
  var Backbone, Connection, DESTROY_BATCH_LIMIT, ModelCache, MongoCursor, MongoSync, QueryCache, Queue, Schema, Utils, bbCallback, moment, util, _;
  ...
  module.exports = MongoSync = (function() {
    ...
    MongoSync.prototype.create = function(model, options) {
      ...
      return this.connection.collection(function(err, collection) {
        var doc;
        if (err) {
          return options.error(err);
        }
